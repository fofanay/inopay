            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="relative p-5 md:p-6 rounded-xl border-2 border-primary/50 bg-gradient-to-r from-primary/5 via-primary/10 to-primary/5 hover:border-primary transition-all">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="font-semibold text-lg">{t('pricing.liberation.title', 'Liberation Pack')}</h4>
                  <span className="text-2xl font-bold text-primary">79$</span>
                </div>
                <p className="text-sm text-muted-foreground mb-4">
                  {t('pricing.liberation.desc', 'ZIP autonome prêt à déployer sur n\'importe quel VPS')}
                </p>
                <Link to="/pricing">
              ...
              <div className="relative p-5 md:p-6 rounded-xl border-2 border-primary bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10">
                <Badge className="absolute -top-3 left-4 bg-primary text-primary-foreground">
                  <Package className="h-3 w-3 mr-1" />
                  {t('pricing.enterprise.badge', 'GROS PROJETS')}
                </Badge>
                <div className="flex items-center justify-between mb-3 pt-2">
                  <h4 className="font-semibold text-lg">{t('pricing.enterprise.title', 'Enterprise')}</h4>
                  <div className="text-right">
                    <span className="text-2xl font-bold text-primary">{t('pricing.enterprise.price', 'Sur devis')}</span>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground mb-4">
                  {t('pricing.enterprise.desc', 'Pour les gros projets (+50 fichiers) ou besoins spécifiques')}
                </p>
                <Link to="/pricing">
                  <Button className="w-full">
                    <Zap className="h-4 w-4 mr-2" />
                    {t('pricing.enterprise.cta', 'Voir les offres')}
